...
- ~~Баг с автоматическим закрытием окна настроек после сохранения~~ (исправлено в v1.2.3)
- ~~Баг с отображением приложений в настройках - показывало "Нет приложений"~~ (исправлено в v1.2.3)
